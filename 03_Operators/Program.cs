...
decimal divisionResult = 5 / 2m;
Console.WriteLine("5 / 2 = " + divisionResult);

double divisionResult2 = 5 / 2d;
Console.WriteLine("5 / 2 = " + divisionResult2);

// % is called modulus. It divides the numbers and gives you the remainder.
